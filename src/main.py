...
def check_to_input_button() -> None:
    ...
    btn = Button(18)
    # btn.when_activated = lambda _ : print("pressed")
    # btn.when_deactivated = lambda _ : print("released")

    cnt = 0
    prev_state = btn.is_active
    while cnt < 10:
        cur_state = btn.is_active
